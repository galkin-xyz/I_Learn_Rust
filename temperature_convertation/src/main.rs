...
fn main() {
    ...
    loop {
        ...
        io::stdin().read_line(&mut code_oper).expect("Ошибка чтения");
        ...
        println!("Введите температуру в градусах {}", temp_type[code_oper - 1]);
        ...
        println!("Температура в градусах {} равна {}", temp_type[code_oper % 2], conv_temp_val);
    }
}
